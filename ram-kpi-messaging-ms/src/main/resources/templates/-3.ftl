            ...
            <table style="background: #F7F8FA; border: 0; border-radius: 0;" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td class="" style="width: 600px;" align="center">
                        <p style="padding: 5px 5px 5px; font-size: 13px; margin: 0 0 0px; color: #ea3131;"
                           align="right">
                        </p>
                        <table
                            ...
                            <tr>
                                <td class="" style="padding: 0px; width: 100%;" align="center">
                                    <table
                                            style="background: #ea3131; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                            cellspacing="0" cellpadding="0">
                                        <tbody>
                                        <tr>
                                            ...
                                            <td class="tw-card-header"
                                                ...
                                                align="center"><span style="font-weight: 600;">Email
                                            ...
                                            <td class="tw-card-body"
                                                ...
                                                <p class=""
                                                   style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                                    <span style="font-weight: 400;">Thank you for
                                                                        joining <strong>Foundation M6
                                                                            App</strong></span><br /><br /><span
                                                            style="font-weight: 400;">To complete the
                                                                        registration process, please confirm your email
                                                                        address to activate your account</span>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table class="button mobile-w-full"
                                                                   style="border: 0px; border-radius: 7px; margin: 0px auto; width: 525px; background-color: #ea3131; height: 50px;"
                                                                   cellspacing="0" cellpadding="0"
                                                                   align="center">
                                                                <tbody>
                                                                <tr>
                                                ...
                                                <p class=""
                                                   style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    ...
                                                    or concerns.&nbsp;<a
                                                            style="color: #ea3131; text-decoration: none;"
                                                            href="javascript:void(0);" target="_blank"
                                                            rel="noopener">Ask us any
                                                        question</a></p>
                                                <p class="tw-signoff"
